...
export default function Home() {
  ...
  return (
    <main className={`min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 ${inter.className}`}>
      {/* Header */}
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-cyan-500 rounded-2xl shadow-lg shadow-indigo-500/30 mb-6">
            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <h1 className="text-5xl font-bold text-white mb-3 tracking-tight">
            Building Energy <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-cyan-300">Predictor</span>
          </h1>
          <p className="text-indigo-200/80 text-lg max-w-2xl mx-auto font-light">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/10">
            <h2 className="text-2xl font-semibold text-white mb-6 flex items-center gap-3">
              <span className="w-8 h-8 bg-indigo-500 rounded-xl flex items-center justify-center text-sm font-bold shadow-lg shadow-indigo-500/30">1</span>
              Building Details
            </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/10 text-white border border-white/20 
                           ...
                           placeholder-indigo-300/50 transition-all duration-200"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <option value="" disabled className="bg-slate-800 text-indigo-200">Select building type...</option>
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none text-indigo-300">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 w-full bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 
                         ...
                         shadow-indigo-500/30 hover:shadow-indigo-500/50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
          ...
          <div className="bg-white/5 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/10">
            <h2 className="text-2xl font-semibold text-white mb-6 flex items-center gap-3">
              <span className="w-8 h-8 bg-emerald-500 rounded-xl flex items-center justify-center text-sm font-bold shadow-lg shadow-emerald-500/30">2</span>
              Prediction Results
            </h2>

            {prediction !== null ? (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 border border-emerald-400/30 rounded-2xl p-6 text-center backdrop-blur-sm">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-emerald-500/20 rounded-2xl mb-3">
                    <svg className="w-8 h-8 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <p className="text-emerald-200 text-sm font-medium mb-2">Predicted Daily Energy</p>
                  <p className="text-5xl font-bold text-white mb-1">{prediction.toFixed(2)}</p>
                  <p className="text-2xl text-emerald-300">kWh</p>
                </div>

                <div className="space-y-3">
                  <div className="bg-white/5 rounded-xl p-4 flex justify-between items-center border border-white/10">
                    <span className="text-indigo-200">Monthly Estimate</span>
                    <span className="text-white font-semibold">{(prediction * 30).toFixed(2)} kWh</span>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 flex justify-between items-center border border-white/10">
                    <span className="text-indigo-200">Annual Estimate</span>
                    <span className="text-white font-semibold">{(prediction * 365).toFixed(2)} kWh</span>
                  </div>
                </div>

                <div className="bg-indigo-500/10 border border-indigo-400/20 rounded-xl p-4 backdrop-blur-sm">
                  <p className="text-indigo-200 text-sm leading-relaxed">
                    💡 This prediction is based on building characteristics and historical patterns. 
                    Actual consumption may vary based on occupancy, equipment, and weather conditions.
                  </p>
                </div>
              </div>
            ) : (
              <div className="flex flex-col items-center justify-center h-64 text-center">
                ...
                <p className="text-indigo-200 mb-2">No prediction yet</p>
                <p className="text-indigo-300/60 text-sm">Fill out the form and click predict to see results</p>
              </div>
            )}
          </div>
        </div>
